package com.openGL.csdn.view.text;
 ...
 * @author YD
 */
public class AlignTextView extends TextView1 {
...
/*
        ...
        for (int i = 0; i < lines.size(); i++) {
            ...
            for (int j = 0; j < line.length(); j++) {
               ...
               // layout=new StaticLayout(line.substring(j, j + 1), paint, 480, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, true);
    ...
    private void measureTextViewHeight(String text, float textSize, int deviceWidth) {
        TextView1 textView = new TextView1(getContext());
